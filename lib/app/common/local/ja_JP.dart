const Map<String, String> ja_JP = {
        ...
        'cash_alarm_tips':'金種@cash が上限に達しました。設定に調整してください。',
  ...
  "spicy_weigh_scale_disconnected":"電子秤が未接続です",
  "spicy_weigh_stable":"重量が安定しました",
  "spicy_weigh_settling":"計量中…安定するまでお待ちください",
  "spicy_weigh_container_tip":"容器の重さはお会計から差し引かれます",
  "spicy_weigh_skip":"計量をスキップ",
  "spicy_weigh_waiting_stable":"安定待ち…",
  "spicy_soup_title":"スープをお選びください",
  "spicy_soup_subtitle":"スープをタップしてください。オプションがある場合は選択画面が開きます",
  "spicy_soup_weigh_amount":"計量金額",
  "spicy_soup_selected_label":"選択中のスープ",
  "spicy_gift_select_option":"特典のオプションを選んでください",
  "spicy_query_failed":"商品の照会に失敗しました。もう一度お試しください",
  "spicy_no_weigh_item":"計量対象の商品がありません",
  "spicy_select_soup_first":"スープを先に選んでください",
  "spicy_weigh_data_error":"計量データに異常があります。再度計量してください",
  "spicy_weight_invalid":"重量が無効です。再度計量してください",
  "spicy_add_cart_failed":"カートへの追加に失敗しました。もう一度お試しください",
  "spicy_processing":"処理中…",
  "spicy_soup_no_extra_option":"このメニューに追加オプションはありません",
  "spicy_soup_select_options":"オプションを選択",
  "spicy_soup_options_for":"@nameのオプションを選択",
  "spicy_soup_recommend":"おすすめ",
  "spicy_weigh_manual_allow_title":"手動入力設定",
  "spicy_weigh_manual_allow":"手動入力を許可する",
  "spicy_weigh_manual_input":"手動入力",
  "spicy_weigh_manual_input_title":"重量を入力（g）",
  "spicy_weigh_manual_ready":"手動入力済み（次へ進めます）",
  "spicy_weigh_below_min":"最低金額未達",
  "spicy_weigh_below_min_tip":"計量金額が最低 @amount 円未満です。追加するか計量をスキップしてください",
  "spicy_weigh_min_amount_hint":"次へ進むには計量金額が ¥@amount 以上必要です",
  "spicy_weigh_tare_hint":"容器の風袋 @tare g を差し引いています。画面の重量は電子秤より少なく表示されます",
  ...
  "spicy_bowl_scan_title":"ボウルのQRコード／バーコードをスキャンしてください",
  "spicy_bowl_scan_subtitle":"スキャンした番号を今回の注文に紐付けます",
  "spicy_bowl_scan_cancel":"キャンセル",
  "spicy_bowl_scan_back":"戻る",
  "spicy_bowl_scan_skip":"計量をスキップ",
  "spicy_bowl_table_no":"ボウル番号：@no",
