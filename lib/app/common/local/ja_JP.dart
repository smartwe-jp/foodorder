const Map<String, String> ja_JP = {
  ...
  "spicy_gift_select_option":"プレゼントのオプションを選んでください",
  ...
  "spicy_weigh_below_min_tip":"計量金額が最低 @amount 円未満です。追加するか秤重をスキップしてください",
  ...
  "spicy_bowl_scan_title":"鉢のQRコード／バーコードをスキャンしてください",
