      ...
      body: GetBuilder<OrderHomeController>(builder: (controller) {
        return controller.obx(
          (state) => AnnotatedRegion(
            ...
            child: controller.isShowTest.value == true
                ? testView()
                : Stack(
                    children: [
                      Container(
                        ...
                        child: Swiper(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return publicShowMenuImage(
                                imgPath: controller.homeList.value[index],
                                imgWidth: 1080.0,
                                imgHeight: 1920.0);
                          },
                          // 配置图片数量
                          ...
                          // 无限循环
                          loop: (controller.homeList.value.length > 1)
                              ? true
                              : false,
                          duration: 1000,
                          autoplayDelay: 12000,
                          // 自动轮播
                          autoplay: (controller.homeList.value.length > 1)
                              ? true
                              : false,
                        ),
                      ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                                    ...
                                    if (controller.dining_type.value == "1" ||
                                      ...
                                      var mealType =
                                          (controller.dining_type.value == "2")
                                              ...
                                              : false;
                                      var jumpUrl =
                                          (controller.menu_direction.value ==
                                                  "1")
                                              ? '/menu-page'
                                              : '/menuzong-page';
                              ...
                              if (controller.machineLanguages_KO.value == true)
                                InkWell(
                                  onTap: () {
                                    controller.isShowTest.value = true;
