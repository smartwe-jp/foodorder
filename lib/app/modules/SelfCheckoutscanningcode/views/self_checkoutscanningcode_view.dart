...
class SelfCheckoutscanningcodeView
  ...
  Widget generateCartList(ShopItemModel d,int index, Animation<double> animation) {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Image.asset(GImage.getImageString("imgpublic", "safeScantop_${controller.checkLanguage.value}"),
              ...
              Container(
                padding: EdgeInsets.only(top: ScreenAdapter.height(15)),
                height: ScreenAdapter.height(1270),
                alignment: Alignment.topCenter,
                child: AnimatedList(
                  key: GlobalKey<AnimatedListState>(),
                  //reverse: true, // 从上往下显示
                  initialItemCount: controller.showCartItems.value.length,
                  itemBuilder: (context, index, animation) {
                    return generateCartList(controller.showCartItems.value[index], index, animation);
                  },
                ),
              ),
              Container(
