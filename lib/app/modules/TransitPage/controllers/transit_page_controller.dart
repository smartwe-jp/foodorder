...
class TransitPageController extends GetxController {
  ...
  _getSmartweSystemSettingInfo() async {
    ...
    var systemSettingData = {
      ...
      "isAllowWlanPrintTwoContinuous":
          (SystemSettingInfo["isAllowWlanPrintTwoContinuous"] != "" &&
              ...
              ? SystemSettingInfo["isAllowWlanPrintTwoContinuous"]
              : "1", //0 单票 1连票
      "isAllowRejishime": (SystemSettingInfo["isAllowRejishime"] != "" &&
    ...
    var smartweMachineSettingPassword =
        await HomeServices.getMachineSettingManagePasswordInfo();
    if (smartweMachineSettingPassword != null &&
        smartweMachineSettingPassword != "") {
      Storage.setString(
          'machineSettingManagePassword', smartweMachineSettingPassword);
      GetxStorage.setData(
          'machineSettingManagePassword', smartweMachineSettingPassword);
    }
