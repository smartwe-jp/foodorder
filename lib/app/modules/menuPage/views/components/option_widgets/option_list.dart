...
import 'package:foodorder/app/modules/menuPage/views/components/option_widgets/widgets/OptionTitle.dart';
...
class _OptionListWidgetState extends State<OptionListWidget> {
  ...
  bool get _canSelect {
    if (_selectedOptions.length == _optionSelectMaxNum && _optionSelectMaxNum > 0) {
      return false;
    } else {
      return true;
    }
