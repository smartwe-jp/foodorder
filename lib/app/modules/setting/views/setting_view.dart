          ...
          children: [
            ...
            InkWell(
              ...
              onTap: () {
                ...
                Get.toNamed('/receipt_query',
                    arguments: {"machineCode": controller.machineCode.value});
              },
              child: Container(
                padding: EdgeInsets.only(
                    left: ScreenAdapter.height(15),
                    right: ScreenAdapter.height(15)),
                    ...
                    children: [
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            var _surplusNum = _detail['standard'] -
                                int.parse(_detail['used']);
                            //var _backColor = (_detail['warm'] > _surplusNum)?"#A61C1C":"#F9F9F9";
                            var _textColor = (_detail['warm'] > _surplusNum)
                                ? "#A61C1C"
                                : "#000000";
                            return Container(
                              alignment: Alignment.center,
                                  ...
                                  Expanded(
                                    ...
                                    child: Text(_detail['name'],
                                        style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.w500,
                                          color:
                                              ColorsUtil.hexToColor(_textColor),
                                        )),
                                  )),
                                  Expanded(
                                      child: Container(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            InkWell(
                              onTap: () async {
                                await controller.ordersqlcontroller
                                    .removeAllFromCart();
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (Platform.isAndroid)
                        CashSettingView(
                          cashInfoList: controller.cashInfoList.value,
                          ...
                          adjustCashFromDeposit:
                              (catVal, number, deposit, qty) {
                            controller.adjustCashFromDeposit(
                                catVal, number, deposit, qty);
                          },
                          resetCash: () {
                            controller.recycleCash('', '');
