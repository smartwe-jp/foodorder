...
class MenuZongPage extends StatefulWidget {
  ...
  MenuZongPage({Key key, this.arguments}) : super(key: key);

  _MenuZongPageState createState() => _MenuZongPageState();
}

class _MenuZongPageState extends State<MenuZongPage>  with AutomaticKeepAliveClientMixin {
    ...
    if (subtitleList.length > 0) {
      ...
      for (var i = 0; i < labelSubtitleLength; i++) {
        labels.add(Chip(
          ...
          backgroundColor: ColorsUtil.hexToColor("#f0f0f0"),
        ));
      }
      return Wrap(
              ...
              children: [
                Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        publicShowMenuImage(item['homeImage'], 340.0, 250.0),
              ...
              children: [
                Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        publicShowMenuImage(item['homeImage'], 260.0, 460.0),
                        SizedBox(
  ...
  //第八个分类 混合排列，第一行一大两小，其余三个一行每页三列一行  饮品
  _showCategoryEight(showItemList) {
    if (showItemList.length > 0) {
        ...
        return Container(
          child: ListView(
            ...
            children: [
                      ...
                      Container(
                        ...
                        child: InkWell(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                publicShowMenuImage(_leftItem['homeImage'], 580.0, 710.0),
                                SizedBox(
                                  height: ScreenAdapter.height(10),
                                ),
                                Container(
                              ...
                              children: [
                                Container(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: <Widget>[
                                        publicShowMenuImage(_rightTop['homeImage'], 400.0, 300.0),
                                        SizedBox(
                                          height: ScreenAdapter.height(10),
                                        ),
                                        Container(
                              ...
                              children: [
                                Container(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: <Widget>[
                                        publicShowMenuImage(_rightBottom['homeImage'], 400.0, 300.0),
                                        SizedBox(
                                          height: ScreenAdapter.height(10),
                                        ),
                                        Container(
              ...
              showCategoryEightItemList(_newItemList)
            ],
          ),
        );
      }else{
        return Container(
          child: showCategoryEightItemList(showItemList),
        );
      }
  ...
  showCategoryEightItemList(items) {
    return Padding(
      padding: EdgeInsets.only(
          top: ScreenAdapter.height(8), bottom: ScreenAdapter.height(8)),
      child: GridView.builder(
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: <Widget>[
                                publicShowMenuImage(item['homeImage'], 250.0, 250.0),
                                (item['optionGroupVoList']?.length > 0)
                                    ? Expanded(
